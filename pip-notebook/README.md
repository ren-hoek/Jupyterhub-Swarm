...
# Pip Jupyter Notebook Stack

A pip based data science notebook, based on the [jupyter/docker-stacks/base-notebook](https://github.com/jupyter/docker-stacks/tree/master/base-notebook) 

## What it Gives You

* Jupyter Notebook 5.0.x with lab extension
* Python 3.5, Python 2.7 and R kernels
* Preinstalled Python packages in [requirements.txt](./requirements.txt)
* Currently no extra installed R packages but could be added in [install.r](./install.r) 
...
```
docker run -it --rm -p 8888:8888 jupyter/pip-notebook
```
